...
class FormE3lan extends Component {
        ...
        return (
            <View key={i} style={{ marginHorizontal : 5 }}>
                ...
                <Image
                    ...
                    source={{
                        uri                   : item && item.length < 500 ? item : `data:image/png;base64,${item}`
                    }}
                    key={i} />
    ...
    images_video = async (i) => {
        ...
        if (i.i === 0) {
            ...
            setTimeout(async () => {
                if (result.base64){
                    this.setState({
                        photos: this.state.photos.concat(result.base64)
                    });
    ...
    getAdd(){
        console.log('base_64 ----------------', base_64.length)
        console.log('Base64_ ----------------', Base64_.length)
                                            ...
                                            <Picker
...

                                                {
                                                    this.state.sub_category.map((sub, i) => (
                                                        <Picker.Item key={i.toString()} label={sub.name} value={sub.id} />
                                                    ))
                                                }
                                            ...
                                            <Picker
...

                                                {
                                                    this.state.all_Color.map((color, i) => (
                                                        <Picker.Item key={i.toString()} label={color.name} value={color.id} />
                                                    ))
                                                }
                                            ...
                                            <Picker
...

                                                {
                                                    this.state.countries.map((country, i) => (
                                                        <Picker.Item key={i.toString()} label={country.name} value={country.id} />
                                                    ))
                                                }
                                            ...
                                            <Picker
...

                                                {
                                                    this.state.cities.map((city, i) => (
                                                        <Picker.Item key={i.toString()} label={city.name} value={city.id} />
                                                    ))
                                                }
